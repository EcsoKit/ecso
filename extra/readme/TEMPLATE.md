...
#if haxelib
The current alpha version requires Haxe 4.2.2. It is strongly advised to use `ecso` with the following targets: HashLink, JavaScript, C++, C#, or Eval (interp). Other targets will be tested progressively.
#end
